...
################################################################################
## Form generated from reading UI file 'render_messTNzhWY.ui'
##
...
class Ui_RenderMess(object):
    def setupUi(self, MainWindow):
        if not MainWindow.objectName():
            MainWindow.setObjectName(u"MainWindow")
        MainWindow.resize(432, 255)
...
"background-color: rgb(85, 255, 255);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"Please select the render method!", None))
    # retranslateUi
