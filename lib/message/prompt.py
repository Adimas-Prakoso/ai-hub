...
################################################################################
## Form generated from reading UI file 'render_messeSZVaD.ui'
##
...
"background-color: rgb(85, 255, 255);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.message.setText(QCoreApplication.translate("MainWindow", u"Please input text in prompt to generate file!", None))
    # retranslateUi
