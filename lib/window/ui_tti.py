...
################################################################################
## Form generated from reading UI file 'ttiwenkwA.ui'
##
...
"border-radius: 10px;")
        ...
        self.help_prompt = QPushButton(self.frame_9)
        self.help_prompt.setObjectName(u"help_prompt")
        self.help_prompt.setMaximumSize(QSize(25, 25))
        self.help_prompt.setCursor(QCursor(Qt.PointingHandCursor))
        self.help_prompt.setStyleSheet(u"border-radius: 10px")
        icon = QIcon()
        icon.addFile(u"./res/image/question-circle-svgrepo-com.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.help_prompt.setIcon(icon)
        self.help_prompt.setIconSize(QSize(25, 25))

        self.gridLayout_11.addWidget(self.help_prompt, 0, 2, 1, 1)
        ...
        self.cuda.setFont(font2)
        self.cuda.setCursor(QCursor(Qt.PointingHandCursor))

        self.gridLayout_10.addWidget(self.cuda, 0, 1, 1, 1)

        self.cpu = QRadioButton(self.frame_8)
        self.cpu.setObjectName(u"cpu")
        self.cpu.setFont(font2)
        self.cpu.setCursor(QCursor(Qt.PointingHandCursor))

        self.gridLayout_10.addWidget(self.cpu, 0, 2, 1, 1)


        self.gridLayout_9.addWidget(self.frame_8, 1, 0, 1, 3)

        self.help_render = QPushButton(self.frame_7)
        self.help_render.setObjectName(u"help_render")
        self.help_render.setMaximumSize(QSize(25, 25))
        self.help_render.setCursor(QCursor(Qt.PointingHandCursor))
        self.help_render.setStyleSheet(u"border-radius: 10px")
        self.help_render.setIcon(icon)
        self.help_render.setIconSize(QSize(25, 25))

        self.gridLayout_9.addWidget(self.help_render, 0, 2, 1, 1)
        ...
        self.help_models = QPushButton(self.frame_5)
        self.help_models.setObjectName(u"help_models")
        self.help_models.setMaximumSize(QSize(25, 25))
        self.help_models.setCursor(QCursor(Qt.PointingHandCursor))
        self.help_models.setStyleSheet(u"border-radius: 10px")
        self.help_models.setIcon(icon)
        self.help_models.setIconSize(QSize(25, 25))

        self.gridLayout_8.addWidget(self.help_models, 0, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.cuda.setText(QCoreApplication.translate("MainWindow", u"CUDA/GPU", None))
        self.cpu.setText(QCoreApplication.translate("MainWindow", u"CPU", None))
        self.help_render.setText("")
