...
################################################################################
## Form generated from reading UI file 'ttmlsGFdg.ui'
##
...
class Ui_TextToMusic(object):
    def setupUi(self, MainWindow):
        if not MainWindow.objectName():
            MainWindow.setObjectName(u"MainWindow")
        MainWindow.resize(480, 316)
        MainWindow.setMinimumSize(QSize(480, 316))
        MainWindow.setMaximumSize(QSize(480, 316))
...
"border-radius: 10px;")
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 426, 185))
